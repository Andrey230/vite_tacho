                ...
                <div>
                    <div className="bg-base-100 p-8  pb-4 rounded-2xl shadow-xl">
                        ...
                        <form onSubmit={onSubmitForm}>
                            ...
                            <p className="text-primary text-sm mt-2">Forgot your password ?</p>
                            <button className="btn btn-primary mt-5">Sign in</button>
                            {error ? <p className="text-error text-sm mt-2">Something went wrong</p> : ""}
                            <NavLink to="/sign-up" className="block text-sm text-primary mt-3 text-right">Create new account</NavLink>
                        </form>
                    </div>
                </div>
            </div>
