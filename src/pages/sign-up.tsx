                    ...
                    <div className="bg-base-100 p-8  pb-4 rounded-2xl shadow-xl">
                        ...
                        <form onSubmit={onSubmitForm}>
                            ...
                            <label className="input flex items-center gap-2 bg-base-200 mt-5">
                                ...
                                <input type="text" className="grow" placeholder="Imię" value={name}
                            ...
                            <label className="label mt-2">
                                ...
                                <div className="ml-2 w-64 text-sm">
                                    Akceptuję <NavLink to="/regulamin" className="text-primary">Regulaminem</NavLink>  i wyrażam zgodę na przetwarzanie danych osobowych.
                                </div>
                            </label>
                            ...
                            <NavLink to="/login" className="block text-sm text-primary mt-3 text-right">Masz już konto ?
                                Zaloguj się</NavLink>
                        </form>
                    </div>
                </div>
